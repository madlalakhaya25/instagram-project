          ...
          `<div class="post" id="${post.id}">
            <div class="header">
              <div class="profile-area">
                <div class="post-pic">
                  <img
                    alt="madlalakhaya's profile picture"
                    class="_6q-tv"
            ...
            <div class="body">
              <img
                alt="Photo by Khaya Madlala on November 08, 2023. Image may contain: 3 people."
                class="FFVAD"
                decoding="auto"
                sizes="614px"
                src="${post.image}"
            ...
            <div class="footer">
              ...
              <span class="comment">
                <span class="caption-username"><b>mpilo_khabaldaka_</b></span>
                <span class="caption-text">Absolutely Amazing Stuff</span>
              </span>
              <span class="comment">
                <span class="caption-username"><b>Thembi_M</b></span>
                <span class="caption-text"> Gorgeous Setup!!</span>
              </span>
              <span class="posted-time">${post.timestamp}</span>
            </div>
            <div class="add-comment">
              <input type="text" placeholder="Add a comment..." />
              <button class="red-icon" onclick="myFunction()">
              <svg aria-label="Emoji" class="x1lliihq x1n2onr6 x1roi4f4" fill="currentColor" height="13" role="img" viewBox="0 0 24 24" width="13">
  <title>Emoji</title>
